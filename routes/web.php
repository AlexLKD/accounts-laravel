...
Route::get('/accounts/update/{id}', [TransactionController::class, 'edit'])->name('transactions.edit');
Route::put('/accounts/update/{id}', [TransactionController::class, 'update'])->name('formUpdate');

Route::get('/accounts/categories', [CategorieController::class, 'index'])->name('categorieIndex');
